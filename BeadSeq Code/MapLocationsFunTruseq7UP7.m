function Illumina=MapLocationsFunTruseq7UP7(OutputDirectory,Bead,IlluminaBarcodes)
...
%        end
    ...
    Illumina=struct('Barcode',IlluminaBarcodes,'HammingDistance',num2cell(hammingdistances),'NumNearestBarcodes',num2cell(NumNearestBarcodes),'Base5Barcode',num2cell(Base5Barcodes),'IndexofBeadBarcode',num2cell(IndexofBeadBarcode),'SOLiDBarcode',UniqueBeadBarcodes(IndexofBeadBarcode),'MappedLocation',UniqueBeadLocations(IndexofBeadBarcode),'Pixels',UniqueBeadPix(IndexofBeadBarcode));
