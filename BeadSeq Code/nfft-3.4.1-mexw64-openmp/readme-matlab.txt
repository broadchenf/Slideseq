This archive contains the Matlab and Octave interface of NFFT 3.4.1 compiled for
64-bit Windows using GCC 7.3.0 x86_64-w64-mingw32 with march=core2, FFTW 3.3.7 and Matlab R2013b and Octave 4.2.2.
