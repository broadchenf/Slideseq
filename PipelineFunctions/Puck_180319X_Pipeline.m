...
FolderWithRawTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Raw\180418 - Pucks 180319-X\';
FolderWithProcessedTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Processed\';
tmpfolder='C:\Users\sgr\pucktmp\';
IndexFiles={'primers n through n-4','primers up through up-4'}; %give the prefixes of each of the files. The next character after should be 't',
...
PuckNames={'Puck_180319_1','Puck_180319_2','Puck_180319_3','Puck_180319_4'}; %give the names of the pucks
...
%    DGE=DGE';
    ...
    Illumina=MapLocationsFunTruseqUP(OutputFolders{puck},Bead,IlluminaBarcodesDownsampled,PrimerNLigationSequence,PrimerUPLigationSequence,NumBases,SaveData,PuckNames{puck});
