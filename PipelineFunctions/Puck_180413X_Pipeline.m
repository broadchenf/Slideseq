...
%This function is for beads with 6 J bases in the first group and 7 J bases
%in the second group.
...
FolderWithRawTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Raw\180423 - Pucks 180413-X\';
FolderWithProcessedTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Processed\';
tmpfolder='C:\Users\sgr\pucktmp\';
IndexFiles={'truseq through up-2','up-3 and up-4'}; %give the prefixes of each of the files. The next character after should be 't',
...
PuckNames={'Puck_180413_1','Puck_180413_2','Puck_180413_3','Puck_180413_4','Puck_180413_5','Puck_180413_6','Puck_180413_7','Puck_180413_8'}; %give the names of the pucks
...
for puck=1:length(PuckNames)
    mkdir([OutputFolderRoot,PuckNames{puck},'_',starttimereadable,'\BeadMapping_',mappingstarttimereadable]);
    MappingOutputFolders{puck}=[OutputFolderRoot,PuckNames{puck},'_',starttimereadable,'\BeadMapping_',mappingstarttimereadable,'\'];
...
%    [UniqueMappedBeads(:).IlluminaBarcode]=deal(IlluminaBarcodesUnique([UniqueMappedBeads.IndexofIlluminaBarcode]));
    ...
    if SaveData
        ...
        save([MappingOutputFolders{puck},'BijectiveMapping.mat'],'UniqueMappedBeads','UniqueMappedDGE','UniqueMappedIlluminaBarcodes','-v7.3');
    end
    %% Plot figures
