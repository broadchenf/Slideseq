...
FolderWithRawTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Raw\180601 - Pucks 180506-X\';
FolderWithProcessedTiffs='C:\Users\sgr\Dropbox (MIT)\Project - SlideSeq\Pucks\Processed\';
tmpfolder='C:\Users\sgr\pucktmp\';
IndexFiles={'primers truseq through up-2','primers up-3 and up-4'}; %give the prefixes of each of the files. The next character after should be 't',
...
PuckNames={'Puck_180506_1','Puck_180506_2','Puck_180506_3','Puck_180506_4','Puck_180506_5','Puck_180506_6','Puck_180506_7','Puck_180506_8'}; %give the names of the pucks
...
for puck=1:length(PuckNames)
    ...
    OutputFolders{puck}=[OutputFolderRoot,PuckNames{puck},'_ModifiedBeadSeqFunV2\'];
