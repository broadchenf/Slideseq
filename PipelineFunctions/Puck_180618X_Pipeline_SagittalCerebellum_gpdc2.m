...
NumClusters=[11,17]; %Cerebellum is 1, hippocampus is 2, frontalcortex is 3, posteriorcortex is 4
...
AnalogizerBeadCutoff=15; %Note that this threshold is only applied for the variable genes used in the NMFreg, so it can be low
