...
%RunAnalogizer=[0,2,2,0,2,0,2,2,2,2,2,2,2,1,1,0,2,2,2,0,2,2,2,2];
RunAnalogizer=[0,2,2,0,2,0,2,2,2,2,2,2,2,0,0,0,0,0,0,0,2,2,2,2];
...
for puck=18%1:length(PuckNames)
...
if CropImage
    for puck=[5,7,8,9,10,11,21,22,23,24]%1:length(PuckNames)
        try
