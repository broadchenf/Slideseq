...
DropboxPath='D:\Sam\Dropbox (Personal)\Projects\Project - SlideSeq'%'D:\Dropbox\Insitubiology Dropbox\insitubiology\Project - SlideSeq';
...
RunAnalogizer=[0,2,2,0,2,0,2,2,2,2,2,2,2,0,2,1,0,0,0,0,2,2,2,2];
...
for puck=15:16%1:length(PuckNames)
...
if CropImage
    for puck=15%1:length(PuckNames)
        try
