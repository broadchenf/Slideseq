...
PucksToAnalyze=[5]; %These are the values of xy from the .nd2 file that will be analyzed.
%Note that the order in PuckNames should match the order in the .nd2 file.
PuckNames={'SLACPuck_180806_5'}; %give the names of the pucks
